...
public class AuditSetContext {
  ...
  public static void setInitialInfo(String prefix, Object parentEntity, String parentEntityId, Object entity, String entityId) {
    setParentEntity(parentEntity, parentEntityId);
    setInitialInfo(prefix, entity, entityId);
  }
  ...
  public static void setInitialInfo(String prefix, Object entity, String entityId) {
